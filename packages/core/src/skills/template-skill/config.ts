...
/**
 * Root of the template-skill module. In @swipi/core this is the same as
 * __dirname because meta-template/ is a sibling of the compiled .js files
 * (we flattened OpenGame's src/ subdirectory during the port).
 */

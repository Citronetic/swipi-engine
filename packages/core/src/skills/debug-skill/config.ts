...
/**
 * Root of the debug-skill module. In @swipi/core this is __dirname itself
 * because seed-protocol/ is a sibling of the compiled .js files (we
 * flattened OpenGame's src/ subdirectory during the port).
 */
